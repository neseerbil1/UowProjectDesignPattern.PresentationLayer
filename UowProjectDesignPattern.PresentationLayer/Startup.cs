...
using UowProjectDesignPattern.BusinessLayer.Concrete;
using UowProjectDesignPattern.DataAccessLayer.Abstract;
using UowProjectDesignPattern.DataAccessLayer.Concrete;
using UowProjectDesignPattern.DataAccessLayer.EntityFrameWork;
using UowProjectDesignPattern.DataAccessLayer.UnitOfWork;

namespace UowProjectDesignPattern.PresentationLayer
{
